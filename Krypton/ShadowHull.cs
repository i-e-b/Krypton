...
namespace Krypton {
	...
	public class ShadowHull {
		/// <summary> The position of the shadow hull </summary>
		public Vector2 Position;

		/// <summary> The angle of the shadow hull </summary>
		public float Angle;

		/// <summary> The maximum radius in which all of the shadow hull's vertices are contained, originating from the hull's position </summary>
		public float MaxRadius;

		/// <summary> The vertices comprising the shadow hull </summary>
		public ShadowHullPoint[] Points;

		/// <summary> The number of vertices comprising the shadow hull </summary>
		public int NumPoints;

		/// <summary> The indicies used to render the shadow hull </summary>
		public Int32[] Indicies;

		/// <summary> The number of indicies used to render the shadow hull </summary>
		public int NumIndicies;

		/// <summary> A value indicating if the hull should cast a shadow </summary>
		public bool Visible = true;

		/// <summary> A value indicating how much to stretch the hull </summary>
		public Vector2 Scale = Vector2.One;

		/// <summary> A value indicating how opaque the shadow is, and inversely how much light goes through the hull </summary>
		public float Opacity = 1f;

		private ShadowHull () {}

		/// <summary> Creates a rectangular shadow hull </summary>
		...
		/// <summary> Creates a custom shadow hull based on a series of vertices </summary>
		...
		public static ShadowHull CreateConvex (ref Vector2[] points) {
			...
			var hull = new ShadowHull { NumPoints = numPoints * 2 };
